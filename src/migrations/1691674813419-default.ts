...
export class Default1691674813419 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "products" DROP COLUMN "restaurant_id"`);
        await queryRunner.query(`ALTER TABLE "products" ADD "restaurant_id" uuid NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "products" DROP COLUMN "restaurant_id"`);
        await queryRunner.query(`ALTER TABLE "products" ADD "restaurant_id" text NOT NULL`);
